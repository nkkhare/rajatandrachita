...
- **Reveal:** the flap lifts and swings away, the envelope drops, and the card rises. The card then assembles in sequence, echoing their beats:
  ...
  2. in place of their flower illustration, the card carries the crest's own scenery: its peaks and forest across the top, and along the bottom their Philadelphia painting (Independence Hall, City Hall, the skyline between them, the river along the foot), with the words between them. Both bands are crops of the couple's own paintings: photographs, however carefully painted over, never matched them. (Code-drawn scenery read as cartoonish; unpainted photos read as too literal; painted photos of a named park still weren't the crest. The couple asked for the crest itself.)
